...
initNum:
	NUM VARNAME asignator expr {initNumVarQ($2, $4); resetRegs();};
initText:
...
assign:
	...
	| VARNAME OPEN_BRACKET expr CLOSE_BRACKET asignator expr {assignValueToListPosQ($1, $3, $6); resetRegs();};
expr:
